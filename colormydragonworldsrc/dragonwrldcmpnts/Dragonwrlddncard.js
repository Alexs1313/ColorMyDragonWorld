...
const Dragonwrlddncard = ({ adv }) => {
  const [toggleIcon, setToggleIcon] = useState(false);
  const { saveDragonWorldDrawing, fetchDragonWorldDrawing } =
  ...
  const addToFavorites = () => {
    ...
    saveDragonWorldDrawing('dragonworlddonedrawings', updatedAdvices, adv);
  };
          ...
          <View style={{ flexDirection: 'row', gap: 30, alignItems: 'center' }}>
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <TouchableOpacity
                activeOpacity={0.7}
                onPress={() =>
                  dragonwrldnavigation.navigate('Dragonwrlddtls', adv)
                }
                style={{
                  flexDirection: 'row',
                  gap: 8,
              ...
              >
                <Text style={styles.dragcorransttl} ellipsizeMode="tail">
                  Watch
                </Text>
                <Image
...
export default Dragonwrlddncard;
